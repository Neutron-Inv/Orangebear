    ...
    <div className="bg-accentblue md:py-14 pb-14 pt-5">
      <div className="md:hidden col-span-1 space-y-6 text-white font-pp-neue-machina mb-10">
        <div className="flex flex-col items-center w-full md:min-w-[10rem] h-full rounded-3xl p-4 md:p-6">
          ...
          <button
            ...
            className="text-white bg-accentorange w-7/12 h-14 font-bold text-lg md:text-2xl rounded-3xl mt-5 shadow-buttonshadow transition duration-700 hover:scale-125 hover:bg-accentblue hover:shadow-orangebuttonshadow"
          >
            Subscribe
          </button>
        </div>
        ...
        <div className="space-y-2 md:space-y-10 font-pp-neue-machina">
          ...
          <ul className="md:list-disc md:ml-4 space-y-2 md:space-y-10 text-xs md:text-sm" style={{ color: "white" }}>
            <li className="md:hidden">
              <Link to="/support" className="text-gray-500 md:text-white text-xs hover:text-gray-300">Privacy Policy</Link>
            </li>
            <li className="md:hidden">
              <Link to="/support" className="text-gray-500 md:text-white text-xs hover:text-gray-300">Terms and Conditions</Link>
            </li>
            <li className="absolute invisible md:visible md:relative">
              <Link to="/support" className="text-gray-500 md:text-white text-xs hover:text-gray-300">Contact Us</Link>
            </li>
            <li className="absolute invisible md:visible md:relative">
      ...
      <div className="mx-auto flex flex-col lg:mx-14 md:flex-row justify-between text-accentorange p-8 md:p-16">
        ...
        <div className="-mt-6 md:mt-0">
          <a href="https://instagram.com/orangebear_ltd?igshid=OGQ5ZDc2ODk2ZA==">
            <img className="float-right w-8 mx-1 -mt-1 md:p-1" src={Ig} alt="Instagram" />
          </a>
          <a href="https://www.facebook.com/Orangebearlimited?mibextid=9R9pXO">
            <img className="float-right w-5 mx-2 -mt-1 md:p-[3px]" src={Fb} alt="Facebook" />
          </a>
          <a href="https://x.com/orangebearl?s=21">
