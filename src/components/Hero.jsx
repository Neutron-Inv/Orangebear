    ...
    <div className="grid grid-cols-1 md:gap-4 p-0 md:p-0 mx-0 md:mx-0 font-light">
      ...
      <div className="flex flex-col space-y-6 md:space-y-10 w-full font-pp-neue-machina lg:pl-10">
        ...
        <div className="flex flex-col md:w-2/5 md:flex-row md:space-x-2 lg:space-x-8 lg:mt-20 space-y-4 md:space-y-0">
          <button className="text-white bg-accentorange mx-auto w-2/5 md:w-1/2 h-12 md:h-14 font-bold text-lg md:text-2xl rounded-3xl shadow-bluebuttonshadow">
            Read Up!
          </button>
          <button className="text-accentorange bg-white mx-auto w-2/5 md:w-1/2 h-12 md:h-14 font-bold text-lg md:text-2xl rounded-3xl shadow-buttonshadow border-2 border-accentorange">
            Preview
          </button>
        </div>
      </div>
